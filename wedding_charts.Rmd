...
#   {.tabset .tabset-fade .tabset-pills .break}
...
We created a word cloud of the words we text to each other most often below:
...
**There seems to be a *slight* downward trend in the length of the texts that we send each other - however, certain events seem to spike longer texts towards one another. The week after we got engaged, Neil's texting character count increased dramatically!**
...
*Below are two bar charts showing the total number of texts we have sent to each other and the average number of text characters in each of our text messages to each other.*
...
*In the chart below, we selected words that we use frequently in texts to each other, or we feel are special to us.*
...
***For better interpretability*****, we have highlighted certain sections of this graph to tell a few stories. Check out the tabs below to see some interesting trends we found in or texting!**

##### "Love<br>you"

**Right after we decided to make it an official relationship, "Love you" made its way into our regular texting. We were quick to say we love each other... And we** *love*\*\* that!\*\*
...
**Snowboarding is one of our favorite hobbies** and we get data from our Mt. Hood Meadows annual ski passes. Thanks to Mt. Hood Meadows for or snowboard data!
...
**Each square below corresponds to the percentage *disposable income* (i.e. necessary expenses like mortgage, utilities, car payments, student loans, etc. are not included) we spend on selected categories. We seem especially interested in spending our disposable income on bars/restaurants and Amazon products!**
...
**Karina spends the most percentage of her disposable income on Amazon purchases and other merchandise!**
...
**Neil spends the majority of his disposable income on bars & Restaurants. Makes sense, he loves to eat and drink!**
...
**As seen in the tabs below,** our relationship milestones seem to have a ***huge impact*** of the S&P 500 and Dow Jones Market increases. Since we first met, both the S&P 500 and Dow Jones the markets have risen dramatically!

<br>

We like to contribute each markets' success to our milestones!
...
***For fun*****, we decided to see if our texting data is predictive of the S&P 500 and Dow Jones market prices.** **We share a passion for working with quantitative data and this was a fun way for us to show off that passion. Karina works regularly with data models in her job in asset management and Neil used to teach statistics to undergraduate/graduate college students.**

<br>

*According to the models in the table below*, when correlated to the absolute market prices of the S&P 500 and Dow Jones markets (controlling for time), ***our texting is predictive of the change in the absolute market price*****.** The relationship is positive and statistically significant.
...
<sup>Note: These models are completely for fun and should *not* be take seriously.</sup>
...
***Interpretation:*** This model is *not* statistically significant: F(2,408) = 0.11, p \>.05, R<sup>2</sup> \< 0.01. Our texting is *not* predictive of the S&P 500 daily difference price.
...
This model is *not* statistically significant: F(2,408) = 0.04, p \>.05, R<sup>2</sup> \< 0.01. Our texting is *not* predictive of the Dow Jones daily difference price.
