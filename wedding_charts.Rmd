...
Each square below corresponds to the percentage *disposable income* (i.e. necessary expenses like mortgage, utilities, car payments, etc. are not included) we spend on selected categories. We seem especially interested in spending our disposable income on bars/restaurants and Amazon products!
